...
export default function Projects2() {
  ...
  const handleClick3 = () => {
    ...
    return(            
        <div id="five" className=" bg-bases border-2 shadow-xl shadow-primary rounded-xl h-[390px] py-3 w-[90%] px-8">
           <section id="four" className=" flex flex-col items-start text-start justify-start ">
           ...
           <div className="relative border-2 rounded-md pt-2 border-text h-[42vh] w-[36%] flex flex-col text-start gap-1 text-2xl font-bold text-text hover:shadow-md hover:shadow-primary">
           <h1 className="style flex justify-center gap-2 text-accent">Blog Website</h1>

<div className="flex flex-col items-end "> 
  
  {isVisible ? (<div className="w-[100%]"><Image src={image1} alt="Project 2" /></div> ): ( <div className="flex justify-start"> <div className="text-textLight font-semibold text-sm px-2">
...
<div className="flex justify-center gap-2 mt-2 text-text">
<Link target="_blank" className="font-bold border-2 border-primary hover:bg-primaryLight hover:shadow-md hover:shadow-primary" href={"https://class-5-lx4r7aa2o-munizazubairs-projects.vercel.app"}> View Live Project</Link> <div className="bg-text h-6 w-[2px] "></div> <Link target="_blank" className="font-bold border-2 border-primary hover:bg-primaryLight hover:shadow-md hover:shadow-primary" href={"https://github.com/munizazubair/class-5.git"} >Github Repository </Link>
</div>
</div>
</div> )}
  </div>
 <div className="flex justify-center">
 <button onClick={handleClick} className=" absolute bottom-0 text-lg hover:shadow-lg hover:shadow-primary h-8 w-[65%] text-center bg-accent">
...
<Link target="_blank" className="font-bold border-2 text-text border-primary hover:bg-primaryLight hover:shadow-md hover:shadow-primary" href={"https://architect-website-class-hackathon-r71j-n1cycc6px.vercel.app"}> View Live Project</Link> <div className="bg-text h-6 w-[2px] "></div> <Link target="_blank" className="font-bold border-2 text-text border-primary hover:bg-primaryLight hover:shadow-md hover:shadow-primary" href={"https://github.com/munizazubair/architect-website-class-hackathon.git"} >Github Repository </Link>
</div>
</div>
</div> )}
  </div>
 <div className="flex justify-center">
 <button onClick={handleClick2} className=" absolute bottom-0 text-lg hover:shadow-lg hover:shadow-primary h-8 w-[65%] text-center bg-accent">
...
<span className="font-bold text-md text-text">Description:</span> A beautifdivly designed photo gallery that adjusts seamlessly across all devices. Featuring a curated collection of stunning images, this gallery enhances user experience.
<br />
<span className="font-bold text-md text-text" >Technologies Used:</span>
...
<span className="font-bold text-md text-text">Key Features: </span> 
 Responsive design, Hover effects on images, Clean layout using CSS Grid, 
<br />
<div className="flex justify-center gap-2 mt-2">
<Link target="_blank" className="font-bold border-2 text-text border-primary hover:bg-primaryLight hover:shadow-md hover:shadow-primary" href={"https://html-ngyy7qexa-munizazubairs-projects.vercel.app"}> View Live Project</Link> <div className="bg-text h-6 w-[2px] "></div> <Link target="_blank" className="font-bold border-2 text-text border-primary hover:bg-primaryLight hover:shadow-md hover:shadow-primary" href={"https://github.com/munizazubair/HTML_CSS.git"} >Github Repository </Link>
</div>
</div></div>)}
 </div>
 <div className="flex justify-center">
 <button onClick={handleClick3} className=" absolute bottom-0 text-lg hover:shadow-lg hover:shadow-primary h-8 w-[65%] text-center bg-accent">
